...
class CheckoutPage:
    ...
    def fill_form(self, subject='private'):
        if subject == 'company':
            self.driver.find_element_by_id('type_f').clear()
            self.driver.find_element_by_id('type_f').click()
            self.driver.find_element_by_id('billing:company').clear()
            self.driver.find_element_by_id('billing:company').send_keys('Testerzy Sp. z o.o.')
            self.driver.find_element_by_id('billing:vat_id').clear()
            self.driver.find_element_by_id('billing:vat_id').send_keys('0123456789')

        self.driver.find_element_by_id('billing:firstname').clear()
        self.driver.find_element_by_id('billing:firstname').send_keys('Test')
        self.driver.find_element_by_id('billing:lastname').clear()
        self.driver.find_element_by_id('billing:lastname').send_keys('Test')
        self.driver.find_element_by_id('billing:email').clear()
        self.driver.find_element_by_id('billing:email').send_keys('test@matrixmedia.pl')
        self.driver.find_element_by_id('billing:street1').clear()
        self.driver.find_element_by_id('billing:street1').send_keys('ul. Testowa')
        self.driver.find_element_by_id('billing:street2').clear()
        self.driver.find_element_by_id('billing:street2').send_keys('1')
        self.driver.find_element_by_id('billing:city').clear()
        self.driver.find_element_by_id('billing:city').send_keys('Testowo')
        self.driver.find_element_by_id('billing:postcode').clear()
        self.driver.find_element_by_id('billing:postcode').send_keys('11-111')
        self.driver.find_element_by_id('billing:telephone').clear()
        self.driver.find_element_by_id('billing:telephone').send_keys('123456789')
